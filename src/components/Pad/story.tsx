...
class ViewportProps {
  ...
  private static props = new ViewportPropsBuilder()
    .withXPosition(ViewportProps.position);
...
storiesOf('Organisms/Pad', module).add('default', () => {
  ...
  return (
    <>
      <Navigation {...navigationProps} className="justify-content-between fixed-top">
